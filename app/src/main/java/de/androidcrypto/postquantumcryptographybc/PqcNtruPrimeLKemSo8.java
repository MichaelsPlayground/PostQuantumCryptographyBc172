...
public class PqcNtruPrimeLKemSo8 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("PQC NTRU LPRime kem SO 8");
        ...
        try {
            PrivateKeyInfo privateKeyInfo = PrivateKeyInfoFactory.createPrivateKeyInfo((NTRULPRimePrivateKeyParameters) privateKeyOriginal);
            ASN1OctetString privateKeyInfoGetPrivateKey = privateKeyInfo.getPrivateKey();
            System.out.println("privateKeyInfoGetPrivateKey: " + privateKeyInfoGetPrivateKey.toString());
            NTRULPRimePrivateKeyParameters ntrulpRimePrivateKeyParameters =  (NTRULPRimePrivateKeyParameters) PrivateKeyFactory.createKey(privateKeyInfo);
            System.out.println("ntrulpRimePrivateKeyParameters: " + ntrulpRimePrivateKeyParameters.toString());

            SubjectPublicKeyInfo subjectPublicKeyInfo = SubjectPublicKeyInfoFactory.createSubjectPublicKeyInfo((NTRULPRimePublicKeyParameters) publicKeyOriginal);
            NTRULPRimePublicKeyParameters ntrulpRimePublicKeyParameters = (NTRULPRimePublicKeyParameters) PublicKeyFactory.createKey(subjectPublicKeyInfo);
            System.out.println("ntrulpRimePublicKeyParameters: " + ntrulpRimePublicKeyParameters.toString());
        } catch (IOException e) {
            e.printStackTrace();
        }
